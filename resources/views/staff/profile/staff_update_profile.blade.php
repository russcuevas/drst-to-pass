        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-col-red">
                    <li><a href="{{ route('staff.dashboard')}} "><i class="material-icons">home</i> Home</a></li>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12col-xs-12 col-centered">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br>
                            <br>
                            <form id="form_advanced_validation" action="{{ route('staff.updaterequest') }}" method="POST" enctype="multipart/form-data">
                                @csrf
